...
export function createCheckoutSessionStartEvent({
  ...
  return {
    ...
    properties: {
      ...
      productInterval: rcPackage.storeProduct.normalPeriodDuration,
      productPrice: rcPackage.storeProduct.price.amountMicros,
      productCurrency: rcPackage.storeProduct.price.currency,
      selectedProductId: rcPackage.storeProduct.identifier,
