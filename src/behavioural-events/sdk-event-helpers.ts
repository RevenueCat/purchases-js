...
export function createCheckoutSessionStartEvent({
  ...
  return {
    ...
    properties: {
      ...
      productInterval: rcPackage.product.normalPeriodDuration,
      productPrice: rcPackage.product.price.amountMicros,
      productCurrency: rcPackage.product.price.currency,
      selectedProductId: rcPackage.product.identifier,
