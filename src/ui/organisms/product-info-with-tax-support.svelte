<script lang="ts">
  ...
  import ProductInfoPricingWithTaxSupport from "../molecules/product-pricing-with-tax-support.svelte";
...
<section>
  <div class="rcb-pricing-info" class:has-expanded-details={isSubscription}>
    ...
    <ProductInfoPricingWithTaxSupport {productDetails} {purchaseOption} />
    <PricingDropdown>
      <PricingTable
        currency="EUR"
