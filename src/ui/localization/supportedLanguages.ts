...
const withRequiredLocalizationKeys = (
  locale: Record<string, string>,
): Record<LocalizationKeys, string> =>
  ({
    ...locale,
    [LocalizationKeys.PricingDropdownAddPromoCode]:
      locale[LocalizationKeys.PricingDropdownAddPromoCode] ?? "Add promo code",
  }) as Record<LocalizationKeys, string>;

export const supportedLanguages: Record<
  string,
  Record<LocalizationKeys, string>
> = {
  en: withRequiredLocalizationKeys(en),
  es: withRequiredLocalizationKeys(es),
  it: withRequiredLocalizationKeys(it),
  ar: withRequiredLocalizationKeys(ar),
  ca: withRequiredLocalizationKeys(ca),
  zh_Hans: withRequiredLocalizationKeys(zh_Hans),
  zh_Hant: withRequiredLocalizationKeys(zh_Hant),
  hr: withRequiredLocalizationKeys(hr),
  cs: withRequiredLocalizationKeys(cs),
  da: withRequiredLocalizationKeys(da),
  nl: withRequiredLocalizationKeys(nl),
  fi: withRequiredLocalizationKeys(fi),
  fr: withRequiredLocalizationKeys(fr),
  de: withRequiredLocalizationKeys(de),
  el: withRequiredLocalizationKeys(el),
  he: withRequiredLocalizationKeys(he),
  hi: withRequiredLocalizationKeys(hi),
  hu: withRequiredLocalizationKeys(hu),
  id: withRequiredLocalizationKeys(id),
  ja: withRequiredLocalizationKeys(ja),
  ko: withRequiredLocalizationKeys(ko),
  ms: withRequiredLocalizationKeys(ms),
  no: withRequiredLocalizationKeys(no),
  pl: withRequiredLocalizationKeys(pl),
  pt: withRequiredLocalizationKeys(pt),
  ro: withRequiredLocalizationKeys(ro),
  ru: withRequiredLocalizationKeys(ru),
  sk: withRequiredLocalizationKeys(sk),
  sv: withRequiredLocalizationKeys(sv),
  th: withRequiredLocalizationKeys(th),
  tr: withRequiredLocalizationKeys(tr),
  uk: withRequiredLocalizationKeys(uk),
  vi: withRequiredLocalizationKeys(vi),
};
