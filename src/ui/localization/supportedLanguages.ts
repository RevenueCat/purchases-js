...
export enum LocalizationKeys {
  ...
  PaymentEntryPageSubscriptionTermsInfoWithoutAppName = "payment_entry_page.subscription_terms_info_without_app_name",
  PaymentEntryPageOtpTermsInfo = "payment_entry_page.otp_terms_info",
  PaymentEntryPageOtpTermsInfoWithoutAppName = "payment_entry_page.otp_terms_info_without_app_name",
  ...
  PaymentEntryPageCheckoutConsentAgreementWithoutAppName = "payment_entry_page.checkout_consent_agreement_without_app_name",
