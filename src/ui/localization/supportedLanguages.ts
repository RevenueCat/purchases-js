...
export enum LocalizationKeys {
  ...
  ErrorPageErrorMessageStripeInvalidTaxOriginAddressPurchaseFailed = "error_page.error_message_stripe_invalid_tax_origin_address_purchase_failed",
  ErrorPageErrorMessageStripeInvalidTaxOriginAddressProduction = "error_page.error_message_stripe_invalid_tax_origin_address_production",
