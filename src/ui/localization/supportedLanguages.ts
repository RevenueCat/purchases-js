...
export enum LocalizationKeys {
  ...
  ProductInfoIntroPricePhasePaidUpfrontPaidOnce = "product_info.intro_price_phase_paid_upfront_paid_once",
  ...
  PricingTablePaymentCycleLengthAndDuration = "pricing_table.payment_cycle_length_and_duration",
  PricingTableIntroPricePaidOnce = "pricing_table.intro_price_paid_once",
  PricingTableIntroPricePaidRecurring = "pricing_table.intro_price_paid_recurring",
  PricingTableFromDatePaidFrequency = "pricing_table.from_date_paid_frequency",
