...
export enum LocalizationKeys {
  ...
  EmailEntryEmailStepTitle = "state_needs_auth_info.email_step_title",
  EmailEntryEmailInputLabel = "state_needs_auth_info.email_input_label",
  EmailEntryEmailInputPlaceholder = "state_needs_auth_info.email_input_placeholder",
  EmailEntryButtonContinue = "state_needs_auth_info.button_continue",
  PaymentEntryPaymentStepTitle = "state_needs_payment_info.payment_step_title",
  PaymentEntryTermsInfo = "state_needs_payment_info.terms_info",
  PaymentEntryTrialInfo = "state_needs_payment_info.trial_info",
  PaymentEntryButtonPay = "state_needs_payment_info.button_pay",
  PaymentEntryButtonStartTrial = "state_needs_payment_info.button_start_trial",
  SuccessPurchaseSuccessful = "state_success.purchase_successful",
  SuccessSubscriptionNowActive = "state_success.subscription_now_active",
  SuccessButtonClose = "state_success.button_close",
  ErrorIfErrorPersists = "state_error.if_error_persists",
  ErrorErrorTitleAlreadySubscribed = "state_error.error_title_already_subscribed",
  ErrorErrorTitleAlreadyPurchased = "state_error.error_title_already_purchased",
  ErrorErrorTitleOtherErrors = "state_error.error_title_other_errors",
  ErrorErrorMessageAlreadySubscribed = "state_error.error_message_already_subscribed",
  ErrorErrorMessageAlreadyPurchased = "state_error.error_message_already_purchased",
  ErrorErrorMessageMissingEmailError = "state_error.error_message_missing_email_error",
  ErrorErrorMessageNetworkError = "state_error.error_message_network_error",
  ErrorErrorMessageErrorChargingPayment = "state_error.error_message_error_charging_payment",
  ErrorErrorMessageErrorSettingUpPurchase = "state_error.error_message_error_setting_up_purchase",
  ErrorErrorMessageUnknownError = "state_error.error_message_unknown_error",
  ErrorButtonTryAgain = "state_error.button_try_again",
