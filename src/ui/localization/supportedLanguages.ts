...
export enum LocalizationKeys {
  ...
  DiscountInputApply = "discount_input.apply",
  DiscountInputApplying = "discount_input.applying",
  DiscountInputErrorEmpty = "discount_input.error_empty",
  DiscountInputErrorApplyFailed = "discount_input.error_apply_failed",
  DiscountInputAppliedDiscountPercentage = "discount_input.applied_discount_percentage",
  DiscountInputRemovePromoCode = "discount_input.remove_promo_code",
